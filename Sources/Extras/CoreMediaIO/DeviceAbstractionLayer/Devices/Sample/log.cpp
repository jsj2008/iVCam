...
{	
	...
	std::string logfile = m_path + "/CameraPlugin.log";
...
{
	std::string origfile = m_path + "/CameraPlugin.log";
	...
	CC_SPRINTF(filename, 256 - 1, "/CameraPlugin_%04d_%02d_%02d_%02d_%02d_%02d.log", 
		tmt->tm_year + 1900,
		tmt->tm_mon + 1,
		tmt->tm_mday,
		tmt->tm_hour,
